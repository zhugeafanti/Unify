...
abstract class CallbackDispatcherGenerator {
  static String className(UniAPIOptions options) =>
      '${options.objcUniAPIPrefix}$kCallbackDispatcher';
