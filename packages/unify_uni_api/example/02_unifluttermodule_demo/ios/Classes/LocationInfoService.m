...
+ (void)setup:(id<FlutterBinaryMessenger>)binaryMessenger {
    ...
    [[FlutterBasicMessageChannel messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.updateLocationInfo" binaryMessenger:binaryMessenger] resizeChannelBuffer:100];
    [[FlutterBasicMessageChannel messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test5" binaryMessenger:binaryMessenger] resizeChannelBuffer:999];
}
...
+ (void)test:(BOOL)st result:(UniCompleted)result {
    FlutterBasicMessageChannel *channel =
        [FlutterBasicMessageChannel
            messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test"
            binaryMessenger:[[self instance] binaryMessenger]];
...
+ (void)test2:(double)st result:(UniCompleted)result {
    FlutterBasicMessageChannel *channel =
        [FlutterBasicMessageChannel
            messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test2"
            binaryMessenger:[[self instance] binaryMessenger]];
...
+ (void)test3:(NSInteger)st result:(UniCompleted)result {
    FlutterBasicMessageChannel *channel =
        [FlutterBasicMessageChannel
            messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test3"
            binaryMessenger:[[self instance] binaryMessenger]];
...
+ (void)test4:(NSInteger)st result:(UniCompleted)result {
    FlutterBasicMessageChannel *channel =
        [FlutterBasicMessageChannel
            messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test4"
            binaryMessenger:[[self instance] binaryMessenger]];
...
+ (void)test5:(NSDictionary<NSString*, NSNumber*>*)st result:(UniCompleted)result {
    FlutterBasicMessageChannel *channel =
        [FlutterBasicMessageChannel
            messageChannelWithName:@"com.didi.flutter.uni_api.LocationInfoService.test5"
            binaryMessenger:[[self instance] binaryMessenger]];
