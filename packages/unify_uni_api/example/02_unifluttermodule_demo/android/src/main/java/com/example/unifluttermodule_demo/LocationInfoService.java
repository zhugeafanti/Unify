...
public class LocationInfoService {
    ...
    public void setup(BinaryMessenger messenger) {
        ...
        new BasicMessageChannel<>(messenger, "com.didi.flutter.uni_api.LocationInfoService.updateLocationInfo", new StandardMessageCodec()).resizeChannelBuffer(100);
        new BasicMessageChannel<>(messenger, "com.didi.flutter.uni_api.LocationInfoService.test5", new StandardMessageCodec()).resizeChannelBuffer(999);
    }
